      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary-dark'
              : 'text-coderx-elements-textSecondary dark:text-coderx-elements-textSecondary-dark hover:text-coderx-elements-textPrimary dark:hover:text-coderx-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-coderx-elements-textTertiary dark:text-coderx-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
