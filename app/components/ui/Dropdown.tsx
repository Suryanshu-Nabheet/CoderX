...
export const DropdownItem = ({ children, onSelect, className }: DropdownItemProps) => (
  <DropdownMenu.Item
    className={classNames(
      ...
      'text-coderx-elements-textPrimary hover:text-coderx-elements-textPrimary',
...
export const DropdownSeparator = () => <DropdownMenu.Separator className="h-px bg-coderx-elements-borderColor my-1" />;
