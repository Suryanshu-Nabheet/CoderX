  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-coderx-elements-borderColor bg-coderx-elements-background-depth-1 text-coderx-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-coderx-elements-textSecondary', className)} {...props} />;
  },
);
