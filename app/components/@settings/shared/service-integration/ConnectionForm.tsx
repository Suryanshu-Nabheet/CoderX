        ...
        {!isConnected ? (
          <div className="space-y-4">
            ...
            <form onSubmit={onConnect} className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className={classNames(
                      ...
                      'bg-coderx-elements-background-depth-1 dark:bg-coderx-elements-background-depth-1',
                      'border border-coderx-elements-borderColor dark:border-coderx-elements-borderColor',
                      'text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary',
                      'focus:outline-none focus:ring-1 focus:ring-coderx-elements-item-contentAccent dark:focus:ring-coderx-elements-item-contentAccent',
                      'disabled:opacity-50',
                    )}
                  >
                    {tokenTypes.map((type) => (
                  ...
                  {selectedTokenType && tokenTypes.find((t) => t.value === selectedTokenType)?.description && (
                    <p className="mt-1 text-xs text-coderx-elements-textTertiary">
              ...
              <div>
                <label className="block text-sm text-coderx-elements-textSecondary mb-2">{tokenLabel}</label>
                <input
                  type="password"
                  value={token}
