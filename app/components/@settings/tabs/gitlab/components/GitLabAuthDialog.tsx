          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="text-base font-medium text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary-dark">
                    GitLab Connection
                  </h3>
                  <p
              ...
              <form onSubmit={handleConnect} className="space-y-4">
                <div>
                  <label className="block text-sm text-coderx-elements-textSecondary dark:text-coderx-elements-textSecondary-dark mb-2">
                    GitLab URL
                  </label>
                  <input
                    type="url"
                    ...
                    className={classNames(
                      ...
                      'text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary-dark',
                      'placeholder-coderx-elements-textTertiary dark:placeholder-coderx-elements-textTertiary-dark',
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                  />
                  <div className="mt-2 text-xs text-coderx-elements-textSecondary dark:text-coderx-elements-textSecondary-dark">
                    <a
