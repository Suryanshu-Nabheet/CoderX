...
export default function NetlifyConnection() {
          ...
          <CollapsibleContent className="overflow-hidden">
            <div className="space-y-4 mt-4">
              <div className="flex flex-wrap items-center gap-4">
                ...
                >
                  <BuildingLibraryIcon className="h-4 w-4 text-coderx-elements-item-contentAccent" />
                ...
                <Badge
                  ...
                  className="flex items-center gap-1 text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary"
                >
                  <RocketLaunchIcon className="h-4 w-4 text-coderx-elements-item-contentAccent" />
                ...
                {lastUpdated && (
                  <Badge
                    ...
                    className="flex items-center gap-1 text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary"
                  >
                    <ClockIcon className="h-4 w-4 text-coderx-elements-item-contentAccent" />
                  ...
                  <div className="bg-coderx-elements-background dark:bg-coderx-elements-background-depth-1 border border-coderx-elements-borderColor dark:border-coderx-elements-borderColor rounded-lg p-4">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="text-sm font-medium flex items-center gap-2 text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary">
                        <BuildingLibraryIcon className="h-4 w-4 text-coderx-elements-item-contentAccent dark:text-coderx-elements-item-contentAccent" />
                        Your Sites
                      </h4>
                      <Button
                        variant="outline"
                      ...
                      >
                        <ArrowPathIcon
                          className={classNames(
                            'h-4 w-4 text-coderx-elements-item-contentAccent dark:text-coderx-elements-item-contentAccent',
                      ...
                      {sites.map((site, index) => (
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <CloudIcon className="h-5 w-5 text-coderx-elements-item-contentAccent dark:text-coderx-elements-item-contentAccent" />
                                ...
                                <div className="flex items-center gap-2">
                                  {siteActions.map((action) => (
                                    <Button
                                      ...
                                      className="flex items-center gap-1 text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary"
                                    >
                                      <action.icon className="h-4 w-4 text-coderx-elements-item-contentAccent dark:text-coderx-elements-item-contentAccent" />
                                      {action.name}
                                    </Button>
                                  ))}
                                </div>
                              ...
                              {site.published_deploy && (
                                <div className="mt-3 text-sm">
                                  <div className="flex items-center gap-1">
                                    <ClockIcon className="h-4 w-4 text-coderx-elements-item-contentAccent dark:text-coderx-elements-item-contentAccent" />
                                  ...
                                  {site.published_deploy.branch && (
                                    <div className="flex items-center gap-1 mt-1">
                                      <CodeBracketIcon className="h-4 w-4 text-coderx-elements-item-contentAccent dark:text-coderx-elements-item-contentAccent" />
                                      <span className="text-coderx-elements-textSecondary dark:text-coderx-elements-textSecondary">
                          ...
                          >
                            ...
                            {deploy.branch && (
                              <div className="mt-2 text-xs text-coderx-elements-textSecondary dark:text-coderx-elements-textSecondary flex items-center gap-1">
                                <CodeBracketIcon className="h-3 w-3 text-coderx-elements-item-contentAccent dark:text-coderx-elements-item-contentAccent" />
                                <span className="text-coderx-elements-textSecondary dark:text-coderx-elements-textSecondary">
                            ...
                            <div className="flex items-center gap-2 mt-2">
                              ...
                              {deploy.state === 'ready' ? (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary"
                                >
                                  <LockClosedIcon className="h-4 w-4 text-coderx-elements-item-contentAccent dark:text-coderx-elements-item-contentAccent" />
                                  Lock
                                </Button>
                              ) : (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary"
                                >
                                  <LockOpenIcon className="h-4 w-4 text-coderx-elements-item-contentAccent dark:text-coderx-elements-item-contentAccent" />
                                  Unlock
                                </Button>
                              )}
                            </div>
                      ...
                      <div className="space-y-2">
                        {builds.map((build) => (
                          ...
                          >
                            ...
                            {build.error && (
                              <div className="mt-2 text-xs text-coderx-elements-textDestructive dark:text-coderx-elements-textDestructive flex items-center gap-1">
                                <XCircleIcon className="h-3 w-3 text-coderx-elements-textDestructive dark:text-coderx-elements-textDestructive" />
                                Error: {build.error}
                              </div>
                            )}
                          </div>
  ...
  return (
    <div className="space-y-6 bg-coderx-elements-background dark:bg-coderx-elements-background border border-coderx-elements-borderColor dark:border-coderx-elements-borderColor rounded-lg">
      <div className="p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-medium text-coderx-elements-textPrimary">Netlify Connection</h2>
          </div>
        </div>
