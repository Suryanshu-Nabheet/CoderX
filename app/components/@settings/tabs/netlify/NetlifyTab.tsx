        ...
        <Collapsible open={isStatsOpen} onOpenChange={setIsStatsOpen}>
            ...
            <div className="flex items-center justify-between p-4 rounded-lg bg-coderx-elements-background dark:bg-coderx-elements-background-depth-2 border border-coderx-elements-borderColor dark:border-coderx-elements-borderColor hover:border-coderx-elements-borderColorActive/70 dark:hover:border-coderx-elements-borderColorActive/70 transition-all duration-200 cursor-pointer">
              ...
              <div
                className={classNames(
                  'i-ph:caret-down w-4 h-4 transform transition-transform duration-200 text-coderx-elements-textSecondary',
          ...
          <CollapsibleContent className="overflow-hidden">
            <div className="space-y-4 mt-4">
              ...
              <div className="mb-6 p-4 bg-coderx-elements-background-depth-1 rounded-lg border border-coderx-elements-borderColor">
                <h4 className="text-sm font-medium text-coderx-elements-textPrimary mb-3">Netlify Overview</h4>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-coderx-elements-textPrimary">
                      {connection.stats.totalSites}
                    </div>
                    <div className="text-xs text-coderx-elements-textSecondary">Total Sites</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-coderx-elements-textPrimary">
                      {connection.stats.totalDeploys || deploymentCount}
                    </div>
                    <div className="text-xs text-coderx-elements-textSecondary">Total Deployments</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-coderx-elements-textPrimary">
                      {connection.stats.totalBuilds || 0}
                    </div>
                    <div className="text-xs text-coderx-elements-textSecondary">Total Builds</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-coderx-elements-textPrimary">
                      {sites.filter((site) => site.published_deploy?.state === 'ready').length}
                    </div>
                    <div className="text-xs text-coderx-elements-textSecondary">Live Sites</div>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-6 space-y-4">
                <h4 className="text-sm font-medium text-coderx-elements-textPrimary">Deployment Analytics</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-coderx-elements-background-depth-2 p-3 rounded-lg border border-coderx-elements-borderColor">
                    <h6 className="text-xs font-medium text-coderx-elements-textPrimary flex items-center gap-2 mb-2">
                      <div className="i-ph:chart-pie w-4 h-4 text-coderx-elements-item-contentAccent" />
                      Success Rate
                    </h6>
                    <div className="space-y-1">
                      {(() => {
                        ...
                        <div key={idx} className="flex justify-between text-xs">
                          <span className="text-coderx-elements-textSecondary">{item.label}:</span>
                          <span className="text-coderx-elements-textPrimary font-medium">{item.value}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="bg-coderx-elements-background-depth-2 p-3 rounded-lg border border-coderx-elements-borderColor">
                    <h6 className="text-xs font-medium text-coderx-elements-textPrimary flex items-center gap-2 mb-2">
                      <div className="i-ph:clock w-4 h-4 text-coderx-elements-item-contentAccent" />
                      Recent Activity
                    </h6>
                    <div className="space-y-1">
                      {(() => {
              ...
              {/* Site Health Metrics */}
              <div className="mb-6">
                <h4 className="text-sm font-medium text-coderx-elements-textPrimary mb-2">Site Health Overview</h4>
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                  {(() => {
                    ...
                    <div
                      key={index}
                      className={`flex flex-col p-3 rounded-lg border border-coderx-elements-borderColor ${metric.bgColor}`}
                    >
                      <div className="flex items-center gap-2 mb-1">
                        <div className={`${metric.icon} w-4 h-4 ${metric.color}`} />
                        <span className="text-xs text-coderx-elements-textSecondary">{metric.label}</span>
                      </div>
              ...
              <div className="flex flex-wrap items-center gap-4">
                <Badge
                  variant="outline"
                  className="flex items-center gap-1 text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary"
                >
                ...
                <Badge
                  ...
                  className="flex items-center gap-1 text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary"
                >
                  <div className="i-ph:rocket-launch w-4 h-4 text-coderx-elements-item-contentAccent" />
                ...
                <Badge
                  ...
                  className="flex items-center gap-1 text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary"
                >
                  <div className="i-ph:hammer w-4 h-4 text-coderx-elements-item-contentAccent" />
              ...
              {sites.length > 0 && (
                <div className="mt-4 space-y-4">
                  <div className="bg-coderx-elements-background dark:bg-coderx-elements-background-depth-1 border border-coderx-elements-borderColor dark:border-coderx-elements-borderColor rounded-lg p-4">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-4">
                        <h4 className="text-sm font-medium flex items-center gap-2 text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary">
                          <div className="i-ph:buildings w-4 h-4 text-coderx-elements-item-contentAccent dark:text-coderx-elements-item-contentAccent" />
                      ...
                      >
                        <div
                          className={classNames(
                            'i-ph:arrows-clockwise w-4 h-4 text-coderx-elements-item-contentAccent dark:text-coderx-elements-item-contentAccent',
                      ...
                      {(isSitesExpanded ? sites : sites.slice(0, 8)).map((site, index) => (
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <div className="i-ph:cloud w-5 h-5 text-coderx-elements-item-contentAccent dark:text-coderx-elements-item-contentAccent" />
                              <span className="font-medium text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary">
                                {site.name}
                              </span>
                            </div>
                            <div className="flex items-center gap-2">
                              ...
                              >
                                ...
                                <span className="text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary">
                            ...
                            <div className="flex items-center gap-4 text-xs text-coderx-elements-textSecondary">
                              {site.published_deploy?.framework && (
                                <div className="flex items-center gap-1">
                                  <div className="i-ph:cube w-3 h-3 text-coderx-elements-item-contentAccent dark:text-coderx-elements-item-contentAccent" />
                                  <span>{site.published_deploy.framework}</span>
                                </div>
                              )}
                              {site.custom_domain && (
                                <div className="flex items-center gap-1">
                                  <div className="i-ph:globe w-3 h-3 text-coderx-elements-item-contentAccent dark:text-coderx-elements-item-contentAccent" />
                                  <span>Custom Domain</span>
                                </div>
                              )}
                              {site.branch && (
                                <div className="flex items-center gap-1">
                                  <div className="i-ph:code w-3 h-3 text-coderx-elements-item-contentAccent dark:text-coderx-elements-item-contentAccent" />
                          ...
                          {activeSiteIndex === index && (
                            <>
                              <div className="mt-4 pt-3 border-t border-coderx-elements-borderColor">
                                <div className="flex items-center gap-2">
                                  {siteActions.map((action) => (
                                    ...
                                    >
                                      <div
                                        className={`${action.icon} w-4 h-4 text-coderx-elements-item-contentAccent dark:text-coderx-elements-item-contentAccent`}
                                      />
                                      {action.name}
                                    </Button>
                                  ))}
                              ...
                              {site.published_deploy && (
                                <div className="mt-3 text-sm">
                                  <div className="flex items-center gap-1">
                                    <div className="i-ph:clock w-4 h-4 text-coderx-elements-item-contentAccent dark:text-coderx-elements-item-contentAccent" />
                                    <span className="text-coderx-elements-textSecondary dark:text-coderx-elements-textSecondary">
                                      Published {formatDistanceToNow(new Date(site.published_deploy.published_at))} ago
                                    </span>
                                  </div>
                                  {site.published_deploy.branch && (
                                    <div className="flex items-center gap-1 mt-1">
                                      <div className="i-ph:code w-4 h-4 text-coderx-elements-item-contentAccent dark:text-coderx-elements-item-contentAccent" />
                                      <span className="text-coderx-elements-textSecondary dark:text-coderx-elements-textSecondary">
                    ...
                    <div className="bg-coderx-elements-background dark:bg-coderx-elements-background-depth-1 border border-coderx-elements-borderColor dark:border-coderx-elements-borderColor rounded-lg p-4">
                      ...
                      <div className="space-y-2">
                        {(isDeploysExpanded ? deploys : deploys.slice(0, 10)).map((deploy) => (
                          <div
                            key={deploy.id}
                            className="bg-coderx-elements-background dark:bg-coderx-elements-background-depth-1 border border-coderx-elements-borderColor dark:border-coderx-elements-borderColor rounded-lg p-3"
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                <Badge
                              ...
                              <span className="text-xs text-coderx-elements-textSecondary dark:text-coderx-elements-textSecondary">
                                {formatDistanceToNow(new Date(deploy.created_at))} ago
                              </span>
                            </div>
                            {deploy.branch && (
                              <div className="mt-2 text-xs text-coderx-elements-textSecondary dark:text-coderx-elements-textSecondary flex items-center gap-1">
                                <div className="i-ph:code w-3 h-3 text-coderx-elements-item-contentAccent dark:text-coderx-elements-item-contentAccent" />
                                <span className="text-coderx-elements-textSecondary dark:text-coderx-elements-textSecondary">
                            ...
                            <div className="flex items-center gap-2 mt-2">
                              ...
                              {deploy.state === 'ready' ? (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary"
                                >
                                  <div className="i-ph:lock-closed w-4 h-4 text-coderx-elements-item-contentAccent dark:text-coderx-elements-item-contentAccent" />
                                  Lock
                                </Button>
                              ) : (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary"
                                >
                                  <div className="i-ph:lock-open w-4 h-4 text-coderx-elements-item-contentAccent dark:text-coderx-elements-item-contentAccent" />
                                  Unlock
                                </Button>
                              )}
                            </div>
                  ...
                  {connection.stats.builds && connection.stats.builds.length > 0 && (
                    <div className="bg-coderx-elements-background dark:bg-coderx-elements-background-depth-1 border border-coderx-elements-borderColor dark:border-coderx-elements-borderColor rounded-lg p-4">
                      <div className="flex items-center justify-between mb-3">
                        <h4 className="text-sm font-medium flex items-center gap-2 text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary">
                          <div className="i-ph:hammer w-4 h-4 text-coderx-elements-item-contentAccent dark:text-coderx-elements-item-contentAccent" />
    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-medium text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary">
            Netlify Integration
          </h2>
        </div>
        <div className="flex items-center gap-2">
      ...
      <p className="text-sm text-coderx-elements-textSecondary dark:text-coderx-elements-textSecondary">
        ...
        <div className="p-6">
          {!connection.user ? (
            <div className="space-y-4">
              <div className="text-xs text-coderx-elements-textSecondary bg-coderx-elements-background-depth-1 dark:bg-coderx-elements-background-depth-1 p-3 rounded-lg mb-4">
                <p className="flex items-center gap-1 mb-1">
                  <span className="i-ph:lightbulb w-3.5 h-3.5 text-coderx-elements-icon-success dark:text-coderx-elements-icon-success" />
                  <span className="font-medium">Tip:</span> You can also set the{' '}
                  <code className="px-1 py-0.5 bg-coderx-elements-background-depth-2 dark:bg-coderx-elements-background-depth-2 rounded">
              ...
              <div>
                <label className="block text-sm text-coderx-elements-textSecondary dark:text-coderx-elements-textSecondary mb-2">
                  API Token
                </label>
                <input
                  type="password"
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-coderx-elements-textSecondary flex items-center gap-1">
                  <div className="i-ph:check-circle w-4 h-4 text-green-500" />
