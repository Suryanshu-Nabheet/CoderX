    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <section aria-labelledby="server-status-heading">
        <div className="flex justify-between items-center mb-3">
          <h2 className="text-base font-medium text-coderx-elements-textPrimary">MCP Servers Configured</h2>{' '}
          <button
      ...
      <section aria-labelledby="config-section-heading">
        <h2 className="text-base font-medium text-coderx-elements-textPrimary mb-3">Configuration</h2>

        <div className="space-y-4">
          <div>
            <label htmlFor="mcp-config" className="block text-sm text-coderx-elements-textSecondary mb-2">
              Configuration JSON
            </label>
            <textarea
              id="mcp-config"
              ...
              className={classNames(
                ...
                'text-coderx-elements-textPrimary',
                'focus:outline-none focus:ring-1 focus:ring-coderx-elements-focus',
              )}
            />
          </div>
          <div>{error && <p className="mt-2 mb-2 text-sm text-coderx-elements-icon-error">{error}</p>}</div>
          <div>
            <label htmlFor="max-llm-steps" className="block text-sm text-coderx-elements-textSecondary mb-2">
