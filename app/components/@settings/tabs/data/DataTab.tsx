...
// Create a custom hook to connect to the coderxHistory database
function useCoderXHistoryDB() {
...
export function DataTab() {
  // Use our custom hook for the coderxHistory database
  const { db, isLoading: dbLoading } = useCoderXHistoryDB();
  ...
  // Data operations hook with coderxHistory database
  const {
    isExporting,
    isImporting,
    isResetting,
  ...
  useEffect(() => {
    if (db) {
      console.log('Loading chats from coderxHistory database', {
        name: db.name,
        version: db.version,
  ...
  return (
    <div className="space-y-12">
      ...
      {/* Settings Section */}
      <div>
        <h2 className="text-xl font-semibold mb-4 text-coderx-elements-textPrimary">Settings</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Card>
            <CardHeader>
              <div className="flex items-center mb-2">
      ...
      {/* API Keys Section */}
      <div>
        <h2 className="text-xl font-semibold mb-4 text-coderx-elements-textPrimary">API Keys</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Card>
            <CardHeader>
              <div className="flex items-center mb-2">
      ...
      {/* Data Visualization */}
      <div>
        <h2 className="text-xl font-semibold mb-4 text-coderx-elements-textPrimary">Data Usage</h2>
        <Card>
