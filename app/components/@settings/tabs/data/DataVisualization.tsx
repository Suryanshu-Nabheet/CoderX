...
export function DataVisualization({ chats }: DataVisualizationProps) {
  ...
  const chartColors = {
    ...
    text: getThemeColor('--coderx-elements-textPrimary'),
    textSecondary: getThemeColor('--coderx-elements-textSecondary'),
    background: getThemeColor('--coderx-elements-bg-depth-1'),
    accent: getThemeColor('--coderx-elements-button-primary-text'),
    border: getThemeColor('--coderx-elements-borderColor'),
  };

  const getChartColors = (index: number) => {
    // Define color palettes based on CoderX design tokens
    const baseColors = [
      // Indigo
      {
        base: getThemeColor('--coderx-elements-button-primary-text'),
      },
      ...
      // Green
      {
        base: getThemeColor('--coderx-elements-icon-success'),
      },
  ...
  if (chats.length === 0) {
    return (
      <div className="text-center py-8">
        <div className="i-ph-chart-line-duotone w-12 h-12 mx-auto mb-4 text-coderx-elements-textTertiary opacity-80" />
        <h3 className="text-lg font-medium text-coderx-elements-textPrimary mb-2">No Data Available</h3>
        <p className="text-coderx-elements-textSecondary">
  ...
  const cardClasses = classNames(
    ...
    'bg-coderx-elements-bg-depth-1',
    'border border-coderx-elements-borderColor',
  );

  const statClasses = classNames('text-3xl font-bold text-coderx-elements-textPrimary', 'flex items-center gap-3');

  return (
    <div className="space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-coderx-elements-textPrimary mb-4">Total Chats</h3>
        ...
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-coderx-elements-textPrimary mb-4">Total Messages</h3>
          <div className={statClasses}>
        ...
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-coderx-elements-textPrimary mb-4">Avg. Messages/Chat</h3>
          <div className={statClasses}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-coderx-elements-textPrimary mb-6">Chat History</h3>
          <div className="h-64">
        ...
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-coderx-elements-textPrimary mb-6">Message Distribution</h3>
          <div className="h-64">
      ...
      {apiKeyUsage.length > 0 && (
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-coderx-elements-textPrimary mb-6">API Usage by Provider</h3>
          <div className="h-64">
