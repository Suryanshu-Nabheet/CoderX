        ...
        <div className="flex-1 space-y-3">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-2">
              ...
              {repo.fork && (
                <div className="i-ph:git-fork w-3 h-3 text-coderx-elements-textTertiary" title="Forked repository" />
              )}
              {repo.archived && (
                <div className="i-ph:archive w-3 h-3 text-coderx-elements-textTertiary" title="Archived repository" />
              )}
            </div>
            <div className="flex items-center gap-3 text-xs text-coderx-elements-textSecondary">
              <span className="flex items-center gap-1" title="Stars">
                <div className="i-ph:star w-3.5 h-3.5 text-coderx-elements-icon-warning" />
                {repo.stargazers_count.toLocaleString()}
              </span>
              <span className="flex items-center gap-1" title="Forks">
                <div className="i-ph:git-fork w-3.5 h-3.5 text-coderx-elements-icon-info" />
          ...
          {repo.description && (
            <p className="text-xs text-coderx-elements-textSecondary line-clamp-2">{repo.description}</p>
          )}
          ...
          {repo.topics && repo.topics.length > 0 && (
            <div className="flex items-center gap-2 text-xs">
              ...
              {repo.topics.length > 3 && (
                <span className="text-coderx-elements-textTertiary">+{repo.topics.length - 3} more</span>
              )}
            </div>
          )}
          ...
          {repo.size && (
            <div className="text-xs text-coderx-elements-textTertiary">Size: {(repo.size / 1024).toFixed(1)} MB</div>
          )}
        </div>
