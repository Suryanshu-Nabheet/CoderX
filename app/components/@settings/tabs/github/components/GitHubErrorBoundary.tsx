...
export class GitHubErrorBoundary extends Component<Props, State> {
  ...
  render() {
    if (this.state.hasError) {
      ...
      return (
        <div className="flex flex-col items-center justify-center p-8 text-center space-y-4 bg-coderx-elements-background-depth-1 border border-coderx-elements-borderColor rounded-lg">
          <div className="w-12 h-12 rounded-full bg-red-50 dark:bg-red-900/20 flex items-center justify-center">
            <AlertTriangle className="w-6 h-6 text-red-500" />
          </div>

          <div>
            <h3 className="text-lg font-medium text-coderx-elements-textPrimary mb-2">GitHub Integration Error</h3>
            <p className="text-sm text-coderx-elements-textSecondary mb-4 max-w-md">
