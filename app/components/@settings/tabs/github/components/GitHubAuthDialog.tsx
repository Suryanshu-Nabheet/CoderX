  ...
  return (
    <Dialog.Root open={isOpen}>
      <Dialog.Portal>
        ...
        >
          <motion.div
            className="bg-coderx-elements-background border border-coderx-elements-borderColor rounded-lg shadow-lg"
          ...
          >
            <div className="p-6 space-y-6">
              ...
              <div className="text-xs text-coderx-elements-textSecondary bg-coderx-elements-background-depth-1 p-3 rounded-lg">
              ...
              <form onSubmit={handleConnect} className="space-y-4">
                <div>
                  <label className="block text-sm text-coderx-elements-textSecondary mb-2">Token Type</label>
                  <select
                    value={tokenType}
                    ...
                    className={classNames(
                      ...
                      'focus:outline-none focus:ring-1 focus:ring-coderx-elements-item-contentAccent',
                      'disabled:opacity-50',
                    )}
                  >
                ...
                <div>
                  <label className="block text-sm text-coderx-elements-textSecondary mb-2">
