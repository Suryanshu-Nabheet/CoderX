  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h2 className="text-xl font-semibold text-coderx-elements-textPrimary">Local Provider Setup Guide</h2>
      ...
      <Card className="bg-gradient-to-r from-blue-500/10 to-blue-500/10 border border-blue-500/20 shadow-sm">
        <CardContent className="p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-coderx-elements-textPrimary">System Requirements</h3>
              <p className="text-sm text-coderx-elements-textSecondary">Recommended hardware for optimal performance</p>
            </div>
          </div>
          <div className="grid md:grid-cols-3 gap-4 text-sm">
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium text-coderx-elements-textPrimary">CPU</span>
              </div>
              <p className="text-coderx-elements-textSecondary">8+ cores, modern architecture</p>
            </div>
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <Database className="w-4 h-4 text-blue-500" />
                <span className="font-medium text-coderx-elements-textPrimary">RAM</span>
              </div>
              <p className="text-coderx-elements-textSecondary">16GB minimum, 32GB+ recommended</p>
            </div>
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <Monitor className="w-4 h-4 text-blue-500" />
                <span className="font-medium text-coderx-elements-textPrimary">GPU</span>
              </div>
              <p className="text-coderx-elements-textSecondary">NVIDIA RTX 30xx+ or AMD RX 6000+</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="bg-coderx-elements-background-depth-2 shadow-sm">
        <CardHeader className="pb-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-xl font-semibold text-coderx-elements-textPrimary">Ollama Setup</h3>
              <p className="text-sm text-coderx-elements-textSecondary">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            <h4 className="font-medium text-coderx-elements-textPrimary flex items-center gap-2">
            ...
            <div className="p-4 rounded-lg bg-green-500/5 border border-green-500/20">
              ...
              <p className="text-sm text-coderx-elements-textSecondary mb-3">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-3 rounded-lg bg-coderx-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-2">
                    <Monitor className="w-4 h-4 text-coderx-elements-textPrimary" />
                    <strong className="text-coderx-elements-textPrimary">macOS</strong>
                  </div>
                  <Button
                    variant="outline"
                    size="sm"
                ...
                <div className="p-3 rounded-lg bg-coderx-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-2">
                    <Monitor className="w-4 h-4 text-coderx-elements-textPrimary" />
                    <strong className="text-coderx-elements-textPrimary">Windows</strong>
                  </div>
                  <Button
                    variant="outline"
                    size="sm"
              ...
              <div className="mt-3 p-3 rounded-lg bg-blue-500/5 border border-blue-500/20">
                ...
                <p className="text-xs text-coderx-elements-textSecondary">
                  ...
                  <code className="bg-coderx-elements-background-depth-4 px-1 rounded">http://localhost:11434</code>
                </p>
              </div>
            </div>

            {/* CLI Installation */}
            <div className="p-4 rounded-lg bg-coderx-elements-background-depth-3">
              <div className="flex items-center gap-2 mb-3">
                <Terminal className="w-5 h-5 text-coderx-elements-textPrimary" />
                <h5 className="font-medium text-coderx-elements-textPrimary">Command Line (Advanced)</h5>
              </div>
              <div className="grid md:grid-cols-3 gap-4">
                <div className="p-3 rounded-lg bg-coderx-elements-background-depth-4">
                  <div className="flex items-center gap-2 mb-2">
                    <Monitor className="w-4 h-4 text-coderx-elements-textPrimary" />
                    <strong className="text-coderx-elements-textPrimary">Windows</strong>
                  </div>
                  <div className="text-xs bg-coderx-elements-background-depth-4 p-2 rounded font-mono text-coderx-elements-textPrimary">
                ...
                <div className="p-3 rounded-lg bg-coderx-elements-background-depth-4">
                  <div className="flex items-center gap-2 mb-2">
                    <Terminal className="w-4 h-4 text-coderx-elements-textPrimary" />
                    <strong className="text-coderx-elements-textPrimary">Linux</strong>
                  </div>
                  <div className="text-xs bg-coderx-elements-background-depth-4 p-2 rounded font-mono text-coderx-elements-textPrimary">
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-coderx-elements-background-depth-3">
                <h5 className="font-medium text-coderx-elements-textPrimary mb-3 flex items-center gap-2">
                  <Code className="w-4 h-4 text-green-500" />
                  Code & Development
                </h5>
                <div className="space-y-2 text-xs bg-coderx-elements-background-depth-4 p-3 rounded font-mono text-coderx-elements-textPrimary">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-blue-500/5 border border-blue-500/20">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-medium text-blue-500">Performance Optimized</span>
                </div>
                <ul className="text-xs text-coderx-elements-textSecondary space-y-1">
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="p-4 rounded-lg bg-green-500/5 border border-green-500/20">
                ...
                <div className="text-xs bg-coderx-elements-background-depth-4 p-3 rounded font-mono text-coderx-elements-textPrimary space-y-1">
      ...
      <Card className="bg-coderx-elements-background-depth-2 shadow-sm">
        <CardHeader className="pb-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-xl font-semibold text-coderx-elements-textPrimary">LM Studio Setup</h3>
              <p className="text-sm text-coderx-elements-textSecondary">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="p-4 rounded-lg bg-coderx-elements-background-depth-3">
                <h5 className="font-medium text-coderx-elements-textPrimary mb-2">Start Local Server</h5>
                <ol className="text-xs text-coderx-elements-textSecondary space-y-1 list-decimal list-inside">
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
                ...
                <div className="space-y-2">
                  <p className="text-xs text-coderx-elements-textSecondary">
                    To work with CoderX, you MUST enable CORS in LM Studio:
                  </p>
                  <ol className="text-xs text-coderx-elements-textSecondary space-y-1 list-decimal list-inside ml-2">
          ...
          <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
            ...
            <ul className="text-xs text-coderx-elements-textSecondary space-y-1 list-disc list-inside">
      ...
      <Card className="bg-coderx-elements-background-depth-2 shadow-sm">
        <CardHeader className="pb-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-xl font-semibold text-coderx-elements-textPrimary">LocalAI Setup</h3>
              <p className="text-sm text-coderx-elements-textSecondary">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-coderx-elements-background-depth-3">
                <h5 className="font-medium text-coderx-elements-textPrimary mb-2">Quick Install</h5>
                <div className="text-xs bg-coderx-elements-background-depth-4 p-3 rounded font-mono text-coderx-elements-textPrimary space-y-1">
              ...
              <div className="p-4 rounded-lg bg-coderx-elements-background-depth-3">
                <h5 className="font-medium text-coderx-elements-textPrimary mb-2">Docker (Recommended)</h5>
                <div className="text-xs bg-coderx-elements-background-depth-4 p-3 rounded font-mono text-coderx-elements-textPrimary space-y-1">
      ...
      <Card className="bg-gradient-to-r from-blue-500/10 to-pink-500/10 border border-blue-500/20 shadow-sm">
        <CardHeader className="pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-coderx-elements-textPrimary">Performance Optimization</h3>
              <p className="text-sm text-coderx-elements-textSecondary">Tips to improve local AI performance</p>
            </div>
          </div>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid md:grid-cols-2 gap-4">
            <div className="space-y-3">
              <h4 className="font-medium text-coderx-elements-textPrimary">Hardware Optimizations</h4>
              <ul className="text-sm text-coderx-elements-textSecondary space-y-2">
            ...
            <div className="space-y-3">
              <h4 className="font-medium text-coderx-elements-textPrimary">Software Optimizations</h4>
              <ul className="text-sm text-coderx-elements-textSecondary space-y-2">
                <li className="flex items-start gap-2">
      ...
      <Card className="bg-coderx-elements-background-depth-2 shadow-sm">
        <CardHeader className="pb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-xl font-semibold text-coderx-elements-textPrimary">Alternative Options</h3>
              <p className="text-sm text-coderx-elements-textSecondary">
        ...
        <CardContent className="space-y-6">
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <h4 className="font-medium text-coderx-elements-textPrimary">Other Local Solutions</h4>
              <div className="space-y-3">
                <div className="p-3 rounded-lg bg-coderx-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-1">
                    <Package className="w-4 h-4 text-blue-500" />
                    <span className="font-medium text-coderx-elements-textPrimary">Jan.ai</span>
                  </div>
                  <p className="text-xs text-coderx-elements-textSecondary">
                ...
                <div className="p-3 rounded-lg bg-coderx-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="font-medium text-coderx-elements-textPrimary">Oobabooga</span>
                  </div>
                  <p className="text-xs text-coderx-elements-textSecondary">
            ...
            <div className="space-y-4">
              <h4 className="font-medium text-coderx-elements-textPrimary">Cloud Alternatives</h4>
              <div className="space-y-3">
                <div className="p-3 rounded-lg bg-coderx-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-1">
                ...
                <div className="p-3 rounded-lg bg-coderx-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="font-medium text-coderx-elements-textPrimary">Together AI</span>
                  </div>
                  <p className="text-xs text-coderx-elements-textSecondary">Fast inference with open-source models</p>
                </div>
                <div className="p-3 rounded-lg bg-coderx-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-1">
