      ...
      try {
        ...
        reader.onload = (e) => {
          ...
          if (textarea) {
            ...
            const setUploadedFiles = (window as any).__CODERX_SET_UPLOADED_FILES__;
            const setImageDataList = (window as any).__CODERX_SET_IMAGE_DATA_LIST__;
            const uploadedFiles = (window as any).__CODERX_UPLOADED_FILES__ || [];
            const imageDataList = (window as any).__CODERX_IMAGE_DATA_LIST__ || [];
