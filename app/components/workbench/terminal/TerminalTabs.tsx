  ...
  return (
    ...
    >
      <div className="h-full">
        <div className="bg-coderx-elements-terminals-background h-full flex flex-col">
          <div className="flex items-center bg-coderx-elements-background-depth-2 border-y border-coderx-elements-borderColor gap-1.5 min-h-[34px] p-2">
                  ...
                  {index == 0 ? (
                    <button
                      ...
                      className={classNames(
                        ...
                        {
                          'bg-coderx-elements-terminals-buttonBackground text-coderx-elements-textSecondary hover:text-coderx-elements-textPrimary':
                            isActive,
                          'bg-coderx-elements-background-depth-2 text-coderx-elements-textSecondary hover:bg-coderx-elements-terminals-buttonBackground':
                            !isActive,
                        },
                      )}
                    ...
                    <React.Fragment>
                      <button
                        ...
                        className={classNames(
                          'flex items-center text-sm cursor-pointer gap-1.5 px-3 py-2 h-full whitespace-nowrap rounded-full',
                          {
                            'bg-coderx-elements-terminals-buttonBackground text-coderx-elements-textPrimary': isActive,
                            'bg-coderx-elements-background-depth-2 text-coderx-elements-textSecondary hover:bg-coderx-elements-terminals-buttonBackground':
                              !isActive,
                          },
                        )}
                      ...
                      >
                        ...
                        <button
                          className="bg-transparent text-coderx-elements-textTertiary hover:text-coderx-elements-textPrimary hover:bg-transparent rounded"
                          onClick={(e) => {
                            e.stopPropagation();
                            closeTerminal(index);
                          }}
            ...
            <IconButton
              ...
              onClick={() => {
                ...
                if (ref?.getTerminal()) {
                  ...
                  if (activeTerminal === 0) {
                    workbenchStore.attachCoderXTerminal(terminal);
                  } else {
              ...
              return (
                <React.Fragment key={`terminal-container-${index}`}>
                  <Terminal
                    ...
                    onTerminalReady={(terminal) => workbenchStore.attachCoderXTerminal(terminal)}
