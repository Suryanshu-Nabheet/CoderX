...
export function Header() {
  ...
  return (
    ...
    >
      ...
      {/* Social Media Links */}
      <nav className="flex items-center gap-2 ml-auto" aria-label="CoderX links">
        <a
          href="https://www.linkedin.com/in/suryanshu-nabheet/"
          target="_blank"
          rel="noopener noreferrer"
          className="flex h-8 w-8 items-center justify-center rounded-md border border-white/10 bg-white/[0.04] text-gray-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400"
          aria-label="LinkedIn"
          title="LinkedIn"
        >
