    ...
    >
      ...
      <div className="flex items-center gap-2 ml-auto">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="text-gray-500 hover:text-gray-300 transition-all duration-300 hover:scale-110"
          title="GitHub"
        >
          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="text-gray-500 hover:text-blue-300 transition-all duration-300 hover:scale-110"
          title="Twitter/X"
        >
          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
