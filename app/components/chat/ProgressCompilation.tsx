      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-coderx-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-coderx-elements-item-backgroundAccent hover:bg-coderx-elements-artifacts-backgroundHover"
