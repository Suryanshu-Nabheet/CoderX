    ...
    try {
      ...
      try {
        ...
        const { data: commitData } = await octokit.git.createCommit({
          owner: connection.user.login,
          repo: sanitizedRepoName,
          message: !repoExists ? 'Initial commit from CoderX' : 'Update from CoderX',
          tree: treeData.sha,
      ...
      <Dialog.Root open={isOpen} onOpenChange={(open) => !open && handleClose()}>
        <Dialog.Portal>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-[10000]">
            ...
            >
              <Dialog.Content
                className="bg-white dark:bg-coderx-elements-background-depth-1 rounded-lg border border-coderx-elements-borderColor dark:border-coderx-elements-borderColor-dark shadow-xl"
                ...
                <div className="p-6 space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="text-lg font-medium text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary-dark">
                          Successfully pushed to GitHub
                        </h3>
                        <p
                          id="success-dialog-description"
                          className="text-sm text-coderx-elements-textSecondary dark:text-coderx-elements-textSecondary-dark"
                        >
                    ...
                    <Dialog.Close asChild>
                      <button
                        onClick={handleClose}
                        className="p-2 rounded-lg transition-all duration-200 ease-in-out bg-transparent text-coderx-elements-textTertiary hover:text-coderx-elements-textPrimary dark:text-coderx-elements-textTertiary-dark dark:hover:text-coderx-elements-textPrimary-dark hover:bg-coderx-elements-background-depth-2 dark:hover:bg-coderx-elements-background-depth-3 focus:outline-none focus:ring-2 focus:ring-coderx-elements-borderColor dark:focus:ring-coderx-elements-borderColor-dark"
                      >
                  ...
                  <div className="bg-coderx-elements-background-depth-2 dark:bg-coderx-elements-background-depth-3 rounded-lg p-4 text-left border border-coderx-elements-borderColor dark:border-coderx-elements-borderColor-dark">
                    <p className="text-sm font-medium text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary-dark mb-2 flex items-center gap-2">
                      <span className="i-ph:github-logo w-4 h-4 text-blue-500" />
                      Repository URL
                    </p>
                    <div className="flex items-center gap-2">
                      <code className="flex-1 text-sm bg-coderx-elements-background-depth-1 dark:bg-coderx-elements-background-depth-4 px-3 py-2 rounded border border-coderx-elements-borderColor dark:border-coderx-elements-borderColor-dark text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary-dark font-mono">
                        {createdRepoUrl}
                      </code>
                      <motion.button
                        onClick={() => {
                        ...
                        className="p-2 text-coderx-elements-textSecondary hover:text-coderx-elements-textPrimary dark:text-coderx-elements-textSecondary-dark dark:hover:text-coderx-elements-textPrimary-dark bg-coderx-elements-background-depth-1 dark:bg-coderx-elements-background-depth-4 rounded-lg border border-coderx-elements-borderColor dark:border-coderx-elements-borderColor-dark"
                  ...
                  <div className="bg-coderx-elements-background-depth-2 dark:bg-coderx-elements-background-depth-3 rounded-lg p-4 border border-coderx-elements-borderColor dark:border-coderx-elements-borderColor-dark">
                    <p className="text-sm font-medium text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary-dark mb-2 flex items-center gap-2">
                    ...
                    <div className="max-h-[200px] overflow-y-auto custom-scrollbar pr-2">
                      {pushedFiles.slice(0, 100).map((file) => (
                        <div
                          key={file.path}
                          className="flex items-center justify-between py-1.5 text-sm text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary-dark border-b border-coderx-elements-borderColor/30 dark:border-coderx-elements-borderColor-dark/30 last:border-0"
                        >
                          <span className="font-mono truncate flex-1 text-xs">{file.path}</span>
                          <span className="text-xs px-2 py-0.5 rounded-full bg-coderx-elements-background-depth-3 dark:bg-coderx-elements-background-depth-4 text-coderx-elements-textSecondary dark:text-coderx-elements-textSecondary-dark ml-2">
                            {(file.size / 1024).toFixed(1)} KB
                          </span>
                        </div>
                      ))}
                      {pushedFiles.length > 100 && (
                        <div className="py-2 text-center text-xs text-coderx-elements-textSecondary dark:text-coderx-elements-textSecondary-dark">
                  ...
                  <div className="flex justify-end gap-2 pt-2">
                    ...
                    <motion.button
                      ...
                      className="px-4 py-2 rounded-lg bg-coderx-elements-background-depth-2 dark:bg-coderx-elements-background-depth-3 text-coderx-elements-textSecondary dark:text-coderx-elements-textSecondary-dark hover:bg-coderx-elements-background-depth-3 dark:hover:bg-coderx-elements-background-depth-4 text-sm inline-flex items-center gap-2 border border-coderx-elements-borderColor dark:border-coderx-elements-borderColor-dark"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
                      <div className="i-ph:copy w-4 h-4" />
              ...
              >
                ...
                <div className="relative text-center space-y-4">
                  ...
                  <motion.div
                    ...
                    className="mx-auto w-16 h-16 rounded-xl bg-coderx-elements-background-depth-3 flex items-center justify-center text-blue-500"
                  >
                  ...
                  <p
                    ...
                    className="text-sm text-coderx-elements-textSecondary dark:text-coderx-elements-textSecondary-dark max-w-md mx-auto"
                  >
                    To deploy your code to GitHub, you need to connect your GitHub account first.
                  </p>
                  <div className="pt-2 flex justify-center gap-3">
                    <motion.button
                      className="px-4 py-2 rounded-lg bg-coderx-elements-background-depth-2 dark:bg-coderx-elements-background-depth-3 text-coderx-elements-textSecondary dark:text-coderx-elements-textSecondary-dark text-sm hover:bg-coderx-elements-background-depth-3 dark:hover:bg-coderx-elements-background-depth-4 border border-coderx-elements-borderColor dark:border-coderx-elements-borderColor-dark"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      onClick={handleClose}
                    >
              ...
              <div className="p-6">
                <div className="flex items-center gap-4 mb-6">
                  <motion.div
                    ...
                    animate={{ scale: 1 }}
                    transition={{ delay: 0.1 }}
                    className="w-10 h-10 rounded-xl bg-coderx-elements-background-depth-3 flex items-center justify-center text-blue-500"
                  >
                    <div className="i-ph:github-logo w-5 h-5" />
                  </motion.div>
                  <div>
                    <Dialog.Title className="text-lg font-medium text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary-dark">
                      Deploy to GitHub
                    </Dialog.Title>
                    <p
                ...
                <div className="flex items-center gap-3 mb-6 p-4 bg-coderx-elements-background-depth-2 dark:bg-coderx-elements-background-depth-3 rounded-lg border border-coderx-elements-borderColor dark:border-coderx-elements-borderColor-dark">
                  ...
                  <div>
                    <p className="text-sm font-medium text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary-dark">
                      {user.name || user.login}
                    </p>
                    <p className="text-sm text-coderx-elements-textSecondary dark:text-coderx-elements-textSecondary-dark">
                      @{user.login}
                    </p>
                  </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <div className="absolute left-3 top-1/2 -translate-y-1/2 text-coderx-elements-textTertiary dark:text-coderx-elements-textTertiary-dark">
                      ...
                      <input
                        ...
                        className="w-full pl-10 px-4 py-2 rounded-lg bg-coderx-elements-background-depth-2 dark:bg-coderx-elements-background-depth-3 border border-coderx-elements-borderColor dark:border-coderx-elements-borderColor-dark text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary-dark placeholder-coderx-elements-textTertiary dark:placeholder-coderx-elements-textTertiary-dark focus:outline-none focus:ring-2 focus:ring-blue-500"
                        required
                        maxLength={100}
                    ...
                    {repoName && sanitizeRepoName(repoName) !== repoName && (
                      <p className="text-xs text-coderx-elements-textSecondary dark:text-coderx-elements-textSecondary-dark mt-1">
                        Will be created as:{' '}
                        <span className="font-mono text-blue-600 dark:text-blue-400">{sanitizeRepoName(repoName)}</span>
                      </p>
                    )}
                  </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between mb-2">
                      <label className="text-sm text-coderx-elements-textSecondary dark:text-coderx-elements-textSecondary-dark">
                        Recent Repositories
                      </label>
                      <span className="text-xs text-coderx-elements-textTertiary dark:text-coderx-elements-textTertiary-dark">
                    ...
                    <div className="mb-2">
                      <SearchInput
                        ...
                        className="bg-coderx-elements-background-depth-2 dark:bg-coderx-elements-background-depth-3 border border-coderx-elements-borderColor dark:border-coderx-elements-borderColor-dark text-sm"
                      />
                    </div>
                        ...
                        {filteredRepos.length === 0 && repoSearchQuery.trim() !== '' ? (
                          ...
                          filteredRepos.map((repo) => (
                            <motion.button
                              ...
                              className="w-full p-3 text-left rounded-lg bg-coderx-elements-background-depth-2 dark:bg-coderx-elements-background-depth-3 hover:bg-coderx-elements-background-depth-3 dark:hover:bg-coderx-elements-background-depth-4 transition-colors group border border-coderx-elements-borderColor dark:border-coderx-elements-borderColor-dark hover:border-blue-500/30"
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="text-sm font-medium text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary-dark group-hover:text-blue-500">
                                    {repo.name}
                                  </span>
                                </div>
                                {repo.private && (
                              ...
                              {repo.description && (
                                <p className="mt-1 text-xs text-coderx-elements-textSecondary dark:text-coderx-elements-textSecondary-dark line-clamp-2">
                                  {repo.description}
                                </p>
                              )}
                  ...
                  <div className="p-3 bg-coderx-elements-background-depth-2 dark:bg-coderx-elements-background-depth-3 rounded-lg border border-coderx-elements-borderColor dark:border-coderx-elements-borderColor-dark">
                    <div className="flex items-center gap-2">
                      <input
                        type="checkbox"
                        id="private"
                        ...
                        className="rounded border-coderx-elements-borderColor dark:border-coderx-elements-borderColor-dark text-blue-500 focus:ring-blue-500 dark:bg-coderx-elements-background-depth-3"
                      />
                      <label
                        htmlFor="private"
                        className="text-sm text-coderx-elements-textPrimary dark:text-coderx-elements-textPrimary-dark"
                      >
                        Make repository private
                      </label>
                    </div>
                    <p className="text-xs text-coderx-elements-textTertiary dark:text-coderx-elements-textTertiary-dark mt-2 ml-6">
