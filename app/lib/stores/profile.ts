...
const storedProfile = typeof window !== 'undefined' ? localStorage.getItem('coderx_profile') : null;
...
export const updateProfile = (updates: Partial<Profile>) => {
  ...
  if (typeof window !== 'undefined') {
    localStorage.setItem('coderx_profile', JSON.stringify(profileStore.get()));
  }
};
