...
echo "Starting CoderX update process..."
...
LATEST_RELEASE_URL=$(curl -s https://api.github.com/repos/Suryanshu-Nabheet/CoderX/releases/latest | grep "browser_download_url.*zip" | cut -d : -f 2,3 | tr -d \")
