...
> tl;dr: We've got a project board with epics and features. We use PRs as change log and as materialized features. Find it [here](https://github.com/Suryanshu-Nabheet/CoderX/projects).
...
You can find the [epics as issues](https://github.com/Suryanshu-Nabheet/CoderX/labels/epic) which are probably never
going to be closed.
